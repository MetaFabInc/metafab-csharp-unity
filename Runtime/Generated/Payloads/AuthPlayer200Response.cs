...
namespace MetafabSdk
{
	...
	public partial class AuthPlayer200Response
	{
		...
		public AuthPlayer200Response(string id, string gameId, string walletId, string connectedWalletId, string profileId, string username, string accessToken, Object profilePermissions, string serviceAuthLookup, string accessTokenExpiresAt, string updatedAt, string createdAt, string walletDecryptKey, WalletModel wallet, WalletModel custodialWallet)
		{
			this.id = id;
			this.gameId = gameId;
