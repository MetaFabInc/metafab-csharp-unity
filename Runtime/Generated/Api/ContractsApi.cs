...
namespace MetafabSdk
{
	public partial class ContractsApi
	{
		...
		public async UniTask<ContractModel> CreateContract(CreateContractRequest createContractRequest, CancellationToken token = default, Dictionary<string, string> headers = null)
		{
			
			return await apiClient.Post<ContractModel>($"/v1/contracts?sdk=unity", createContractRequest, headers: headers);
		...
		public async UniTask<List<ContractModel>> GetContracts(CancellationToken token = default, Dictionary<string, string> headers = null)
		{
			
			return await apiClient.Get<List<ContractModel>>($"/v1/contracts?sdk=unity", headers: headers);
		...
		public async UniTask<Object> ReadContract(string contractId, string func,string args,CancellationToken token = default, Dictionary<string, string> headers = null)
		{
			
			return await apiClient.Get<Object>($"/v1/contracts/{contractId}/reads?sdk=unity&func={ func }&args={ args }", headers: headers);
		...
		public async UniTask<TransactionModel> TransferContractOwnership(string contractId, TransferContractOwnershipRequest transferContractOwnershipRequest, CancellationToken token = default, Dictionary<string, string> headers = null)
		{
			
			return await apiClient.Post<TransactionModel>($"/v1/contracts/{contractId}/owners?sdk=unity", transferContractOwnershipRequest, headers: headers);
		...
		/// </remarks>
		/// <returns>TransactionModel</returns>
		public async UniTask<TransactionModel> UpgradeContractTrustedForwarder(string contractId, UpgradeContractTrustedForwarderRequest upgradeContractTrustedForwarderRequest, CancellationToken token = default, Dictionary<string, string> headers = null)
		{
			
			return await apiClient.Post<TransactionModel>($"/v1/contracts/{contractId}/forwarders?sdk=unity", upgradeContractTrustedForwarderRequest, headers: headers);
		...
		/// </remarks>
		/// <returns>TransactionModel</returns>
		public async UniTask<TransactionModel> WriteContract(string contractId, WriteContractRequest writeContractRequest, CancellationToken token = default, Dictionary<string, string> headers = null)
		{
			
			return await apiClient.Post<TransactionModel>($"/v1/contracts/{contractId}/writes?sdk=unity", writeContractRequest, headers: headers);
