...
namespace MetafabSdk
{
	public partial class PlayersApi
	{
		...
		public async UniTask<UpdatePlayer200Response> UpdatePlayer(string playerId, UpdatePlayerRequest updatePlayerRequest, CancellationToken token = default)
		{
			
			return await apiClient.Patch<UpdatePlayer200Response>($"/v1/players/{playerId}?sdk=unity", updatePlayerRequest);
